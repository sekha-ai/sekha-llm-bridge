...
PRICING_TABLE: Dict[str, ModelPricing] = {
    ...
    "claude-3-haiku": ModelPricing(input_cost_per_1k=0.00025, output_cost_per_1k=0.00125),
    
    # Moonshot (Kimi)
    "kimi-2.5": ModelPricing(input_cost_per_1k=0.0001, output_cost_per_1k=0.0002),
    "moonshot-v1-8k": ModelPricing(input_cost_per_1k=0.00012, output_cost_per_1k=0.00012),
    "moonshot-v1-32k": ModelPricing(input_cost_per_1k=0.00024, output_cost_per_1k=0.00024),
    "moonshot-v1-128k": ModelPricing(input_cost_per_1k=0.00060, output_cost_per_1k=0.00060),
    
    # DeepSeek
    "deepseek-v3": ModelPricing(input_cost_per_1k=0.00014, output_cost_per_1k=0.00028),
    "deepseek-chat": ModelPricing(input_cost_per_1k=0.00014, output_cost_per_1k=0.00028),
...
def compare_costs(model_ids: list[str], input_tokens: int, output_tokens: int = 0) -> Dict[str, float]:
