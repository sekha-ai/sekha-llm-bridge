...
class TestMultiDimensionSearch:
    ...
    async def test_limit_results_per_collection(self):
        ...
        def search_multi_dimension(query, limit_per_collection=10, total_limit=20):
            collections = ["conversations_768", "conversations_1536", "conversations_3072"]
            all_results = []
        ...
        results = search_multi_dimension("test query", limit_per_collection=5, total_limit=10)
...
class TestDimensionSwitching:
    ...
    async def test_handle_concurrent_dimensions(self):
        ...
        active_models = [
            ...
            {"id": "text-embedding-3-large", "dimension": 3072, "use_case": "high_quality"},
        ]
        ...
        assert get_collection_for_model("text-embedding-3-large") == "conversations_3072"
